...
import loader.elbrus.xml.XMLGraphsWarning;

/**
 * ActiveMQGraphsWarning
...
@Service
public class ActiveMQGraphsWarning {
  ...
  @Autowired
  XMLGraphsWarning xmlGraphsWarning;
    ...
    consumer.setMessageListener(new MessageListener() {
      ...
      public void onMessage(Message bytesMessage) {
        try {
          ...
          Document document = xmlGraphsWarning.createXMLFile(timetableWarnsMessage, mRequest, dateStart, dateFinish);
  ...
  private void createMQSender(String filePathRespond, MRequest mRequest, int requestIntervalTimeMinute) throws Exception { 
    mqSender.setId(LALog.SHORT_LOADERCOMM_ID + mRequest.getId());
