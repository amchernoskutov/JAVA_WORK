...
import com.smartsoft.form.RegistrationForm;
...
public class RegistrationController {
  ...
  @PostMapping
  public String processRegistration(RegistrationForm registrationForm, @Valid User user, Errors errors, Map<String, Object> model) {
    if (userRepo.findByUsername(registrationForm.getUsername()) != null) {
      errors.rejectValue("username", "error.user", "Пользователь с таким именем уже зарегистрирован");
    }
